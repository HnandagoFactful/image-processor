...
export const initial2ColImgVIewerLayout: {[key: string]: Layout[]} = {
    lg: [
        ...
        { i: 'b', x: 3, y: 0, w: 9, minW: 3, maxW: 12, h: 10, isDraggable: false, isResizable: true, isBounded: false },
    ...
    md: [
        ...
        { i: 'b', x: 4, y: 0, w: 8, minW: 3, maxW: 12, h: 10, isDraggable: false, isResizable: true, isBounded: false },
